...
export const WORLDVIEW_FAN_VISUAL: Record<string, WorldviewFanVisual> = {
  wv_core_laws: {
    shell: "border-indigo-700/35 bg-[oklch(0.96_0.035_280)] min-w-[160px]",
  ...
  wv_spatiotemporal: {
    shell: "border-teal-700/35 bg-[oklch(0.96_0.035_175)] min-w-[160px]",
    icon: "text-teal-700",
  ...
  wv_social_power: {
    shell: "border-violet-700/35 bg-[oklch(0.96_0.035_300)] min-w-[160px]",
  ...
  wv_history_culture: {
    shell: "border-amber-700/35 bg-[oklch(0.97_0.04_85)] min-w-[160px]",
    icon: "text-amber-700",
  ...
  wv_existence: {
    shell: "border-emerald-700/35 bg-[oklch(0.96_0.035_155)] min-w-[160px]",
  ...
  wv_info_flow: {
    shell: "border-sky-700/35 bg-[oklch(0.95_0.035_220)] min-w-[160px]",
    icon: "text-sky-700",
